...
const data = {
  home: [
    { id: 1, label: "Baby", name: "Pikin", img: babyImg },
    { id: 2, label: "Sibling", name: "Sibling", img: siblingImg },
    { id: 3, label: "Mother", name: "Mama", img: motherImg },
    { id: 4, label: "Spouse", name: "Papa", img: spouseImg },
    { id: 5, label: "Sex", name: "Sex", img: sexImg },
    { id: 6, label: "Health", name: "Health For Everybody", img: healthImg },
  ],
